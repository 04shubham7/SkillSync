...
function MeetingCard({ interview }: { interview: Interview }) {
    ...
    return (
        ...
        >
            <Card className="group h-full w-full flex flex-col rounded-xl border border-white/10 bg-gradient-to-br from-white/5 to-white/2 dark:from-white/5 dark:to-white/1 backdrop-blur-md hover:border-blue-500/50 hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-300 relative overflow-hidden">
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 bg-gradient-to-tr from-blue-500/10 via-indigo-500/10 to-transparent pointer-events-none transition-opacity duration-300" />
